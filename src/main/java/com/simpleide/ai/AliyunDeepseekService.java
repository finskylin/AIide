...
public class AliyunDeepseekService implements AIService {
    private static final String API_URL = "https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions";
    private static final String API_KEY = "sk-7dbab50f830b4e8bafef48049f1cefb5";
    ...
    private String sendRequest(String prompt) throws IOException {
        ...
        systemMessage.put("content", 
                ...
                "2. 你给出的所有代码修改建议,都要使用=== 完整文件名 ===格式清晰指出针对哪个文件\n" +
                "3. 需要具体说明修改文件的代码行位置，非连续修改要分别列出来,同时指出是新增或修改文件"+
                "4. 必须在代码块中使用```代码类型:新增|修改|第[几-几]行:完整文件名 格式```\n" +
                "5. 确保代码格式规范，使用正确的缩进\n" +
                "6. 只返回需要修改的代码，不需要说明使用案例，不需要说明修改的原因和思路"+
                "7. 示例:```java:修改:第[1-4]行:src/main/java/JsonUtil.java"
